...
namespace CS_ASP_031
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        public string displayMonsterStats(string monsterName, int health)
        {
            return String.Format("<p>{0} Current Stats<br />Health: {1}</p>", monsterName, health);
        }

        //Cant overload with same params even if return method is different

        //public void displayMonsterStats(string monsterName, int monsterDamage){ }

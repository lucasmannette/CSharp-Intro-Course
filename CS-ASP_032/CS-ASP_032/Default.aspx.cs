    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                //can not skip optional parameter in the middle.
                //optional methods must be at the end of the method declaration
                //monsterHealth = performAttack(monsterHealth,20,"Hero","Monster",,12)
        ...
        private int performAttack(int defenderHealth, int attackerDamageMax, string attackerName, string defenderName, double criticalHitChance = .1, double defenderArmorBonus = 5)
        {
